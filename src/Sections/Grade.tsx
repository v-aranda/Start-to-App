    ...
    return(
        ...
        <section id='Sobre' className='flex flex-col items-center'>
            <h1 className="text-center text-xl font-bold">
                Durante o Curso
                <br />
                <span className="inter-900 text-violet-700 text-5xl lg:text-6xl">Você Aprenderá</span>
            </h1>
            <div className="grid lg:grid-cols-2 lg:w-9/12">
                <div className='p-8 flex flex-col items-center'>
                    <img className='w-2/4 md:w-full' src={discoverying} alt="Homem buscando informações de negócio em um computador" />
                ...
                <div className='p-8 flex flex-col items-center'>
                    <img className='w-2/4 md:w-full' src={delivering} alt="Mulher Desenvolvendo seu produto" />
